...
<div class="site-about">
  <div class="article-banner" style="background-image: url('<?php echo StaticURL::make('images/site/banner','about.png'); ?>');">
  ...
  <div class="article">
      ...
      <p>Last updated: <?php echo date('Y-m-d H:i:s',filemtime(__FILE__)) ?> UTC</p>
  </div>
</div>
